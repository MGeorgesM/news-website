...
if (document.title === 'Restaurants Website') {
  ...
  const loginBtns = [loginBtn, loginBtnCollapsed];
  ...
  favoriteFilterFound &&
    favoriteFilterFound.addEventListener('click', () => {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    scrollRestaurantsBtn.addEventListener('click', () =>
  ...
  //Profile Redirection
  const profileBtns = [navbarProfileLink, navbarProfileLinkCollapsed];
